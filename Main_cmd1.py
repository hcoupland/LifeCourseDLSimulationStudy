...
if __name__ == '__main__':
    run(name=name, model_name=model_name, randnum_split=randnum_split,randnum_train=randnum_train,epochs=epochs,num_optuna_trials=num_optuna_trials,hype=hype, imp=imp,filepath=filepath,device=device,folds=folds)
